...
class Performance extends Component {
  ...
  getPerformances = () => {
    ...
    axios
      .get(endpoint + "auth/api/performances", {
        withCredentials: true,
      })
      .then((res) => {
        //console.log(res);
  ...
  render() {
    ...
    if (this.state.types.length === 0) {
      conditional_render = (
        <Header> You haven't scheduled any concerts yet </Header>
      );
    }
    return (
      <div>
        <Grid divided="vertically" style={gridoffset}>
          <Grid.Row columns={1}>
            ...
            <Portal
              ...
              openOnTriggerClick
              trigger={
                <Button onClick={this.add} style={buttonoffset}>
                  {" "}
              ...
              >
                ...
                >
                  ...
                  <div style={{ display: "flex", height: "55px" }}>
                    ...
                    >
                      <div className="button-text" style={{ color: "blue" }}>
                        CANCEL
                      </div>
                    </Button>
                  </div>
