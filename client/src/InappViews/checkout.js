...
function MenuBar(props) {
  return (
    <div>
      <Grid fluid padded={false} columns={2} style={gridS}>
        <Grid.Row fluid stye={greenBut}>
          ...
          <Grid.Column>
            <div style={call}>
              {" "}
              Call <span style={phone}>778-329-3030</span> for assistance{" "}
            </div>
          </Grid.Column>
        </Grid.Row>
      </Grid>
      <Menu
        fluid
        style={{ marginTop: "19px", boxShadow: "none", border: "none" }}
      >
        <Menu.Item style={tabs}>
          <div style={border_select}>
            <div style={tabText}>Summary</div>
          </div>
        </Menu.Item>
...
class Checkout extends Component {
  ...
  panel() {
    return (
      <Portal open={this.state.addressOpen}>
        <div
          style={{
            height: "100%",
            width: "1366px",
  ...
  render() {
    ...
    return (
      <div>
              ...
              <Grid.Column>
                ...
                >
                  <div class="shipping-details">
                    Shipping Details{" "}
                    <span class="change-order" onClick={this.fillAddress}>
                      Change
                    </span>
                  </div>
                  <Divider
                  ...
                  <div class="address">
                    ...
                    <br />
                    <br />
                    <span style={{ marginLeft: "0px" }} class="change-order">
                ...
                >
                  ...
                  <div className="checkout-info">
                    ...
                    <span class="checkout-amount">
                      CDN$ {this.props.bundleData.itemcost}
                    </span>
                    <br />
                    Shipping & Handling{" "}
                    <span class="checkout-amount">
                      CDN$ {this.props.bundleData.shipcost}
                    </span>
                  </div>
                  <Divider
                    style={{ marginLeft: "24px", marginRight: "22px" }}
                  />
                  <div className="checkout-info">
                    Total before tax:{" "}
                    <span class="checkout-amount">
                      CDN$ {this.props.bundleData.pretax}
                    </span>
                    <br />
                    Estimated GST/HST:{" "}
                    <span class="checkout-amount">
                      CDN$ {this.props.bundleData.gst}
                    </span>
                    <br />
                    Estimated PST/RST/QST:{" "}
                    <span class="checkout-amount">
                      CDN$ {this.props.bundleData.pst}
                    </span>
                  </div>
                  <Divider
                    style={{
                  ...
                  <div class="savings-footer">
                    <div class="savings-checkout">
                      <Popup
                        className="pop-up"
                        content="On average, a lumber trader would take 7-12% commision from each trade. You save by using lumber.io"
                        trigger={<Icon name="info circle" />}
                      />
                      <span style={{ float: "right" }}>
                        {" "}
                        My Savings: CDN${this.props.bundleData.saving}
                      </span>
                    </div>
                  </div>
                </Card>
        ...
        <Portal open={!this.state.address.prompt}>
          <div
            style={{
              height: "100%",
              width: "1366px",
          ...
          >
            ...
            >
              ...
              <div
                style={{ marginLeft: "26px", marginTop: "22px" }}
                class="address"
              >
                {this.state.address.name}
                <br />
