      ...
      <div>
        <div class="info-top">
          <div class="info-header">
            {" "}
            <u> {this.props.bundleData.type}</u>{" "}
          </div>
          <Link to="/lumber">
            <Icon className="info-exit" size="big" name="close" />{" "}
          </Link>
        </div>
        <div>
          <Link to="/checkout">
            <Button className="info-button">SELECT THIS BUNDLE </Button>
          </Link>
        </div>
        <Grid style={third_offset}>
          <Grid.Row columns={1} style={{ marginTop: "0px" }}>
            <Card
              padded={false}
              fluid
              style={{ width: "1287px", height: "100%" }}
            >
              <span class="info-expand">Market Size</span>
              <ExtraContentAccordion
                onClick={this.toggleCard0.bind(this)}
        ...
        <Grid style={gridoffset}>
          <Grid.Row
            columns={2}
            style={{ marginTop: "0px", width: "624px", height: "451px" }}
          >
            <Grid.Column style={{ paddingLeft: "0px", paddingRight: "0px" }}>
              <Card
                padded={false}
                fluid
                style={{ width: "624px", height: "451px" }}
              >
        ...
        <Grid style={second_offset}>
          <Grid.Row columns={1} style={{ marginTop: "0px" }}>
            ...
            >
              ...
              <ExtraContentAccordion
                onClick={this.toggleCard1.bind(this)}
                content="Some Market Analysis to be filled in"
        ...
        <Link to="/checkout">
          ...
          <Button
            ...
            style={{ marginTop: "40px", marginBottom: "115px" }}
          >
            SELECT THIS BUNDLE{" "}
          </Button>
        </Link>
